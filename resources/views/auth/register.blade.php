                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form  action="{{ route('register-proses') }}" method="post" class="mt-5 mb-5 login-input">
                                    @csrf
                                    ...
                                    <p class="mt-5 login-form__footer">Have account <a href="{{'masuk'}}" class="text-primary">Sign Up </a> now</p>
                                    </p>
                                </div>
                            </div>
                        </div>
